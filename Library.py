...
class AllBook:
    def __init__(self):
        ...
        db = sqlite3.connect("e:\\Librarydb.db")
...
class Transection:
   def __init__(self):
        self.r3=Tk()
        self.r3.geometry("400x400")
        self.r3.title("Transections")
        self.l=Label(self.r3,text="Transections",font=("bold",25))
        self.lb=Listbox(self.r3,width=58,height=18)
        self.l.place(x=120,y=10)
        self.lb.place(x=20,y=70)
        db = sqlite3.connect("e:\\Librarydb.db")
...
b3=Button(root,text="Tranactions",font=("normal",20),width=12,command=Trans)
l.place(x=40,y=30)
